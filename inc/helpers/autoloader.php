 ...
 *
 * @package bento-embeds-featuers
 */

namespace Bento_Embeds\Features\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'Bento_Embeds\Features\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( BENTO_EMBEDS_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Bento_Embeds\Features\Inc\Helpers\autoloader' );
